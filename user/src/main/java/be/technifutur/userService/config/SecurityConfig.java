package be.technifutur.userService.config;

import be.technifutur.userService.security.JWTAuthentificationFilter;
...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(
                new JWTAuthentificationFilter(jwtProperties),
